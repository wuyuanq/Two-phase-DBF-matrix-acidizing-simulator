...
contains
    ...
    subroutine export2tecplot(g_poro, g_Sw, g_Kxx, g_vxw, g_vxn, g_vyw, g_vyn, g_p, g_Cf)
        ...
        call exportPointCenteredIJ_vars(vars_a, (/"poro", "Sw  ", "Kxx ", "vxw ", "vxn ", "vyw ", "vyn ", "p   ", "Cf  "/), &!
